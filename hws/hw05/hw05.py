...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, withdraw_password):
        ...
        if len(wrong_passwords) == 3:
            ...
            wrong_passwords.append(withdraw_password)
...
def make_joint(withdraw, old_pass, new_pass):
    ...
    """
    "*** YOUR CODE HERE ***"
    old_pass_vertify = withdraw(0, old_pass)
    if type(old_pass_vertify) == str:
        return old_pass_vertify
    joint_password = [old_pass, new_pass]
    def new_withdraw(amount, password):
            return withdraw(amount, old_pass) if password in joint_password else withdraw(amount, password)
    return new_withdraw
